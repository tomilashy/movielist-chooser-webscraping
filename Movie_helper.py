...
movie_ratings=movie_ratings.sort_values(['year', 'imdb'], ascending=[False, False])
movie_ratings=movie_ratings.drop_duplicates(subset=['movie', 'year'], keep='first')#use false to completely drop all
